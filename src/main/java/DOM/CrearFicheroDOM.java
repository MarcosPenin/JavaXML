...
public class CrearFicheroDOM {
    ...
    public static void main(final String[] args) throws IOException {
        File fichero = new File ("NombresEdades_new.dat");
        
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        int nRegs=Fichero.numeroRegistros(fichero);
        
        Fichero.crear(fichero);
        Altas.altas(br, fichero, nRegs);
        ...
        try{
            ...
            "PersonasCreado", null);// crea el documento con el nodo raíz de nombre Personas
            ...
            if(clave > 0){ // clave valida
                ...
                CrearElemento("edad",
                Float.toString(edad),raiz,documento);// añadir edad
